...
H
	full_text;
9
7%30 = bitcast double* %0 to [37 x [37 x [5 x double]]]*
6sext8B,
*
	full_text

...
e
	full_textX
V
T%124 = call double @llvm.fmuladd.f64(double %123, double -1.750000e+01, double %118)
,double8B

	full_text
...
j
	full_text]
[
Y%133 = call double @llvm.fmuladd.f64(double %132, double 0x408CB60000000002, double %124)
,double8B

	full_text
...
e
	full_textX
V
T%147 = call double @llvm.fmuladd.f64(double %146, double -1.750000e+01, double %135)
,double8B

	full_text
...
d
	full_textW
U
S%156 = call double @llvm.fmuladd.f64(double %155, double 1.225000e+02, double %147)
,double8B

	full_text
...
j
	full_text]
[
Y%161 = call double @llvm.fmuladd.f64(double %160, double 0x408CB60000000002, double %156)
,double8B

	full_text
...
e
	full_textX
V
T%183 = call double @llvm.fmuladd.f64(double %182, double -1.750000e+01, double %163)
,double8B

	full_text
...
j
	full_text]
[
Y%188 = call double @llvm.fmuladd.f64(double %187, double 0x40646AAAAAAAAAAA, double %183)
,double8B

	full_text
...
j
	full_text]
[
Y%193 = call double @llvm.fmuladd.f64(double %192, double 0x408CB60000000002, double %188)
,double8B

	full_text
...
e
	full_textX
V
T%205 = call double @llvm.fmuladd.f64(double %204, double -1.750000e+01, double %195)
,double8B

	full_text
...
d
	full_textW
U
S%214 = call double @llvm.fmuladd.f64(double %213, double 1.225000e+02, double %205)
,double8B

	full_text
...
j
	full_text]
[
Y%219 = call double @llvm.fmuladd.f64(double %218, double 0x408CB60000000002, double %214)
,double8B

	full_text
...
e
	full_textX
V
T%237 = call double @llvm.fmuladd.f64(double %236, double -1.750000e+01, double %221)
,double8B

	full_text
...
j
	full_text]
[
Y%246 = call double @llvm.fmuladd.f64(double %245, double 0xC04D666666666664, double %237)
,double8B

	full_text
...
j
	full_text]
[
Y%255 = call double @llvm.fmuladd.f64(double %254, double 0x40346AAAAAAAAAAA, double %246)
,double8B

	full_text
...
j
	full_text]
[
Y%264 = call double @llvm.fmuladd.f64(double %263, double 0x406E033333333332, double %255)
,double8B

	full_text
...
j
	full_text]
[
Y%269 = call double @llvm.fmuladd.f64(double %268, double 0x408CB60000000002, double %264)
,double8B

	full_text
